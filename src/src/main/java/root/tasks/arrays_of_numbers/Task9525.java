...
public class Task9525 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит данные - целые числа, разделенные символов \",\". Каждая пара чисел обозначает границы интервалов. Каждое число относится только к одному интервалу. Вывести границы всех интервалов в столбик, меньшую границу - слева. Вывести стрелочку \"<--\" напротив интервалов, в которые попадает число 19 (сравнивать включительно).");
