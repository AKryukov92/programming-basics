...
public class Task8428 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendTaskId();
        appendTaskDesc("Какое название лучше выбрать для переменной? Эта проблема подробно рассмотрена в главе 11.1 \"Общие принципы выбора имен переменных\" части III книги \"Совершенный код\". <a href=\"Stiv_Makkonnell_-_Sovershenny_kod_2-e_izdanie.pdf#page=274\" target=\"_blank\">(открыть в новой вкладке)</a>");
        ...
        appendTaskHeader();
        appendTaskDesc("Перевести угол из градусов в радианы по формуле: <formula>angleRadian=angleDegree*&pi;/180</formula>, где angleDegree - угол в градусах(degrees), angleRadian - угол в радианах. <a href=\"https://ru.wikipedia.org/wiki/%D0%A0%D0%B0%D0%B4%D0%B8%D0%B0%D0%BD\" target=\"_blank\">Радиан</a> - угол, соответствующий дуге, длина которой равна её радиусу. Единица измерения плоских углов в Международной системе единиц (СИ).");
