...
public class Task8557 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит данные - названия глав, разделенные запятыми. Вывести содержание. Каждый пункт оформить по шаблону \"Глава $i $name\", где i - номер главы, name - название соответствующей главы. Нумерация глав должна начинаться с 1.");
