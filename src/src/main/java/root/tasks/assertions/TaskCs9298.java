...
public class TaskCs9298 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        ...
        appendOrderedNonEscaped(
                ...
                "<zoom>==</zoom> Истинно, если значение слева <b>строго равно</b> значению справа",
                "<zoom>!=</zoom> Истинно, если значение слева <b>строго не равно</b> значению справа"
        );
        appendFooter();
    }

    public static void main(String[] args) {
        System.out.println(new TaskCs9298());
    }
}
