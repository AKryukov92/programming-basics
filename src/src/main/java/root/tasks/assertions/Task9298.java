...
public class Task9298 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        ...
        /*
        Это все не про то. Надо чтобы студент
        1. Написал все команды вывода решения.
        2. Написал все команды вывода ошибок.
        3. Для каждой команды подумал, когда её можно выполнять?
        4.
        вот у нас один вариант действий и другой вариант действий.
        Могут ли эти варианты работать одновременно?
        Если не могут, то надо писать if(){} else {}
        Если могут, то надо писать
        if(){}
        if(){}
         */
        appendOrdered(
