...
public class Task2173 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит данные - целые числа, разделенные символом \";\"(точка с запятой). Проверить, что массив отсортирован по возрастанию. Если какой-то элемент нарушает закономерность, вывести его индекс, значение и прекратить проверку.");
