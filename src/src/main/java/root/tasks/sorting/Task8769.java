...
public class Task8769 extends MultipleInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит числа from и to и данные - целые числа, разделенные пробелами. Напечатать элементы, у которых индекс находится между from и to включительно. Между элементами с индексами from и to включительно нужно найти индекс минимального числа и его значение. ");
