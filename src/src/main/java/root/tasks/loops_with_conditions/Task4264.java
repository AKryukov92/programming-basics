...
public class Task4264 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит число N. Программа должна вывести на экран два столбика чисел. В первом должны быть числа от 0 до N включительно. Определите закономерность в значениях второго столбика по тестовым примерам и реализуйте программу.");
