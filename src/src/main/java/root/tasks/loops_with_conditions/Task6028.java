...
public class Task6028 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит число X, которое обозначает угол в градусах. Вывести на экран в столбик число X, а также 20 следующих чисел с шагом 67 градусов. Справа от каждого числа вывести результат вычисления функции 3+10*cos(x). Если значение функции больше 11 или меньше -6, то написать \"ЗА ПРЕДЕЛАМИ\".");
