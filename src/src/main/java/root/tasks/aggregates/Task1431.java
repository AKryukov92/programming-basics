...
public class Task1431 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит данные - целые числа, разделенные пробелами. Нужно найти два наибольших числа. Если есть два одинаковых числа с наибольшим значением, то вывести их оба.");
