...
public class Task5053 extends TwoInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescNonEscaped("Выведите на экран <i>в строчку</i> числа от from до to включительно. Если from &lt; to,  то в порядке возрастания. Иначе - в порядке убывания. Перед списком чисел напишите в каком порядке они выводились.");
