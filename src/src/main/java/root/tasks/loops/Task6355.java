...
public class Task6355 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDesc("Пользователь вводит число seed. Вывести 10 строчек по 7 чисел в каждой. В первой строчке - числа начиная с seed по возрастанию c шагом 1. Во второй строчке - с шагом 2 и так далее. В строчке 10 шаг должен быть равен 10. После двоеточия поставьте символ табуляции \"\\t\"");
