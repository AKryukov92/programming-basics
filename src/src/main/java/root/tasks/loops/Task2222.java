...
public class Task2222 extends TwoInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит два числа: P и Q. Вывести в столбик 20 чисел по возрастанию, которые делятся без остатка на P. Написать фразу \"делится на Q\" после каждого числа, которое делится без остатка на Q. Если пользователь вввел не положительное число, вывести сообщение об ошибке.");
