...
public class TaskCs5259 extends TwoInputValLayout {
    ...
    protected void makeLayout() {
        ...
        appendOrdered(
                ...
                "Создайте проект Lab13Task1934.",
                "В проекте Lab13Task1934 добавьте ссылку на проект CodeProject.",
                "Добавьте команду using пространства имен из проекта CodeProject.",
                "Создайте еще один метод в классе Program проекта Lab13Task1934. Назовите его Step1934. Он ничего не возвращает и не принимает аргументов."
        );
        ...
        appendOrdered(
                ...
                "В результате запуска проекта Lab13Task1934, в консоли должен выводиться текст из таблицы с тестовыми данными, из колонки \"Исходный результат\". Возможны отличия в номерах строк и расположении файлов."
        );
        ...
        appendCheckValuesRowNoLogic("13", "15", "Начало работы программы\n" +
                ...
                "   at Lab13Task1934.Program.Step1934() in E:\\Stage2\\Lab13Task1934\\Program.cs:line 24\n" +
                "   at Lab13Task1934.Program.Main(String[] args) in E:\\Stage2\\Lab13Task1934\\Program.cs:line 15");
        appendCheckValuesRowNoLogic("word", "4", "Начало работы программы\n" +
                ...
                "   at Lab13Task1934.Program.Step1934() in E:\\Stage2\\Lab13Task1934\\Program.cs:line 23\n" +
                "   at Lab13Task1934.Program.Main(String[] args) in E:\\Stage2\\Lab13Task1934\\Program.cs:line 15");
        ...
        appendOrdered(
                "Обработайте ArgumentException так, чтобы на экран выводилось сообщение из исключения",
                ...
                "Проверьте, что исключения обработаны корректно"
        );
        appendCheckValuesHeader("A", "B");
