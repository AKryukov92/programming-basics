...
public class Task7940 extends StreamInputLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDesc("Пользователь вводит день недели, час и минуту начала занятия, час и минуту конца занятия. Нужно проверить, что в расписании отсутствуют пересекающиеся занятия.");
        appendFooter();
    }
