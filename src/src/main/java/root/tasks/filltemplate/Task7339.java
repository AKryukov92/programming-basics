...
public class Task7339 extends LayoutMaker {
    ...
    protected void makeLayout() {
        ...
        appendCheckSingle("print(\"микро\" + \"мир\")");
        appendTaskDesc("В результате получится:");
        appendCheckSingle("микромир");
        appendTaskDesc("Напишите еще несколько слов с применением конкатенации:");
        appendCheckSingle("синезеленый\nвысокоскоростной\nотказоустойчивый\nау");
        appendFooter();
    }
}
