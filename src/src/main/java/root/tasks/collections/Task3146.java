...
public class Task3146 extends StreamInputLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDesc("В файле слова, которые могут повторяться. Нужно запомнить сколько раз встречается каждое слово. Пользователь вводит бесконечное количество чисел. После каждого числа нужно вывести на экран слова, которые повторяются указанное количество раз.");
