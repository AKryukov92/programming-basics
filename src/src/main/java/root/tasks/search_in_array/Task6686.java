...
public class Task6686 extends StreamInputLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDesc("Пользователь вводит 4 числа одно за другим. Нужно сравнить первое и второе число. Вывести наибольшее из них. Затем сравнить наибольшее и третье число. Вывести наибольшее. Затем сравнить наибольшее и четвертое число. Вывести итоговое наибольшее.");
