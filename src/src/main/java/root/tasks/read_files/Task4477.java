...
public class Task4477 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Файл с исходными данными содержит открывающие '{' и закрывающие '}' фигурные скобки. На каждой строке находится только одна скобка. Если в строке содержится что-то другое, нужно вывести сообщение об ошибке. Нужно определить максимальную глубину вложенности, вывести подробный ход решения.");
