...
public class Task1761 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Первая строка исходного файла содержит наименование агрегатной функции (functionName). Затем идет пустая строка. Остальные строки файла содержат целые числа, написаные в столбик без дополнительного оформления. Количество чисел в файле заранее неизвестно. Вычислить результат агрегатной функции.");
        ...
        appendTaskDescEscaped("Результат - целое число с округлением вниз. Ответ вывести по шаблону:");
        appendCheckSingleNonEscaped("$functionName\n" +
                "------------\n" +
                "$result");
