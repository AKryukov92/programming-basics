...
public class Task6589 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит массив чисел, разделенных символом ','. Числа объединены парами и описывают два интервала \"зеленый\" и \"красный\". Интервал считается корректным если для него выполняется условие A<B. Нужно определить: пересекаются ли данные два интервала чисел. Если не пересекаются, то написать объяснение.");
