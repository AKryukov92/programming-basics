...
public class Task6589 extends MultipleInputValLayout {
    @Override
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDesc("Даны два интервала чисел red(A;B) green(A;B). Интервал считается корректным если для него выполняется условие A&lt;B. Нужно определить: пересекаются ли данные два интервала чисел. Если не пересекаются, то написать объяснение.");
