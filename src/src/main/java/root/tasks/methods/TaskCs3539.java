...
public class TaskCs3539 extends LayoutMaker {
    ...
    protected void makeLayout() {
        ...
        appendOrdered(
                "В классе Methods реализуйте публичный статический метод Task9271",
        ...
        appendOrdered(
                ...
                "Вызовите статический метод Task9271 класса Methods. Передайте ему массив data в качестве аргумента.",
