...
public class TaskCs7581 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Дан массив текстовых фрагментов. Определить, присутствует ли в данном массиве символ \"x\". Чтобы определить, что символ отсутствует, сравнивайте каждый элемент массива с эталоном \"x\". Если они равны, тогда возвращайте значение true. Если весь массив был просмотрен, а равных элементов не было найдено, верните false.");
