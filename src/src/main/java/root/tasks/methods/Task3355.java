...
public class Task3355 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Пользователь вводит число total. Сформируйте текст сообщения, который состоит из нескольких частей. Основная часть сообщения содержит все целые числа от 1 до total включительно. Перед каждым числом нужно написать слово \"Глава\". В начале сообщения должно находиться слово \"Введение\", а после всех чисел - слово \"Заключение\". Для оформления сообщения в несколько строк, добавьте спецсимвол \"\\n\" в конце каждой строки.");
