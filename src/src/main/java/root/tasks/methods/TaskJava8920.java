...
public class TaskJava8920 extends TwoInputValLayout {
    @Override
    ...
    protected void makeLayout() {
        ...
        appendOrdered(
                ...
                "Корректность результатов каждого вызова метода task4283 проверьте с помощью статического метода assertEquals класса Assert.",
