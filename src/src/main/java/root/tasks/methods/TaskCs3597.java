...
public class TaskCs3597 extends OneInputValLayout {
    ...
    protected void makeLayout() {
        appendHeader();
        appendTaskDescEscaped("Даны вещественные числа a, b, c. Если a равно 0, вернуть сообщение об ошибке \"Уравнение не является квадратным\". Найдите в прошлых работах формулу для вычисления дискриминанта, вычислите его и напишите одно из трех сообщений в зависимости от полученного значения.");
