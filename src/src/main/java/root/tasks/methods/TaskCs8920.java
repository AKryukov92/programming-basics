...
public class TaskCs8920 extends TwoInputValLayout {
    ...
    protected void makeLayout() {
        ...
        appendOrderedNonEscaped(
                "В классе Library реализуйте публичный статический метод Task4283.",
        ...
        appendOrderedNonEscaped(
                ...
                "В теле юнит-теста 4 раза вызовите статический метод Task4283 класса Library. При каждом вызове в качестве аргументов нужно передавать значения из разных тестов, описанных в задаче.",
