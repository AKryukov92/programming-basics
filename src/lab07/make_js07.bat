...
echo ^<div class="nav"^> ^
 ...
 ^<li^>^<a href="#task3657" class="example"^>№ 12^</a^>^</li^> ^
 ^<li^>^<a href="#task6599"^>№ 13^</a^>^</li^> ^
 ^<li^>^<a href="#task1618"^>№ 14^</a^>^</li^> ^
 ^</ul^> ^
 ^</div^>>>%filename%
...
type writingjs8165.html>>%filename%
type writingjs9001.html>>%filename%
