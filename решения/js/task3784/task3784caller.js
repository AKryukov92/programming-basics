...
var in6556a = ["3","7","2","13","23","-2","3","13","6911"];
var in6556b = ["5","1","13","11","3","8","-4","15","5881"];
var in6556c = ["7","11","5","7","9","9","5","-17","3203"];
var in6556d = ["9","3","19","19","11","7","6","19","-4639"];
...
var in5870 = [4000, 3603, 3599, 3660, 59, 61, 0, -1, -20];
var out5870 = [
...
for (var i = 0; i < in5870.length; i++){
	try{
		var out = document.getElementById("5870t" + i);
		var result = task5870(in5870[i]);
		out.innerHTML = "Получилось: " + result + "<br/>Ожидалось : " + out5870[i];
	} catch (e){
		out.innerHTML = "Получилось: " + e.message + "<br/>Ожидалось : " + out5870[i];
	}
}